...
CircularInt& CircularInt::operator/=(const int number) {
	...
	throw string("this number is not in the {" + to_string(this->first) + "," + to_string(this->last) + "} such that x*" + to_string(number) + "=" + to_string(this->current));
}
...
CircularInt& CircularInt::operator/=(const CircularInt& hour) {
	...
	throw string("this number is not in the  {" + to_string(this->first) + "," + to_string(this->last) + "} such that x*" + to_string(Object.current) + "=" + to_string(this->current));
}